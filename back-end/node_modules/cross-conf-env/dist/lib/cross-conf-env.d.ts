 ...
 * @returns Keys.
 */
export declare const filterKeys: () => string[];
/**
 ...
 * @returns Augments.
 */
export declare const replaceArgv: (argv: string[], keys: string[]) => string[];
/**
 * Replace the value of the command line arguments in process.env, and run the process with a replaced arguments.
 * @param argv Arguments of the command line.
 * @returns Process.
 */
export declare const crossConfEnv: (argv: string[]) => any;
